...
import { ArrowRight, BookOpen, Globe, Calculator, Languages, Mic } from "lucide-react";
...
const HomeFeatures = () => {
  ...
  return (
    <section className="py-24 bg-background-dark relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-primary/20 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[minmax(200px,auto)]">
          ...
          {/* Large card — Study Abroad (2 cols × 2 rows) */}
          <div className="md:col-span-2 md:row-span-2 group relative rounded-2xl overflow-hidden shadow-xl bg-[#07101e]">
            <div
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#07101e] via-[#07101e]/80 to-transparent" />
            <div className="absolute inset-0 bg-primary/40 group-hover:bg-primary/20 transition-colors duration-500" />
            <div className="absolute inset-0 p-8 md:p-10 flex flex-col justify-end">
              <div className="w-14 h-14 bg-accent/20 backdrop-blur-md rounded-xl flex items-center justify-center mb-6 group-hover:bg-accent group-hover:text-[#07101e] transition-all duration-300 text-accent">
              ...
              <Link
                href="/study-abroad"
                className="inline-flex w-fit items-center px-6 py-3 bg-accent/10 border border-accent/20 backdrop-blur-sm rounded-lg text-sm font-medium text-accent hover:bg-accent hover:text-[#07101e] transition-all uppercase tracking-wider"
              >
          ...
          {/* Medium card — SAT (1 col × 2 rows) */}
          <div className="md:col-span-1 lg:col-span-1 md:row-span-2 surface-1 p-8 rounded-2xl group relative overflow-hidden flex flex-col justify-between border border-white/5 hover:border-accent/30 transition-all duration-500">
          ...
          {/* Small card — IELTS (1 col × 1 row) */}
          <div className="md:col-span-1 lg:col-span-1 md:row-span-1 surface-1 p-6 md:p-8 rounded-2xl group relative overflow-hidden flex flex-col justify-between border border-white/5 hover:border-accent/30 transition-all duration-500">
          ...
          {/* Small card — General English (1 col × 1 row) */}
          <div className="md:col-span-1 lg:col-span-1 md:row-span-1 surface-1 p-6 md:p-8 rounded-2xl group relative overflow-hidden flex flex-col justify-between border border-white/5 hover:border-accent/30 transition-all duration-500">
            <div className="absolute -bottom-4 -right-4 opacity-5 group-hover:opacity-10 transition-opacity duration-500">
          ...
          {/* Wide CTA — View All Services (full width) */}
          <div className="md:col-span-3 lg:col-span-4 rounded-2xl p-[1px] bg-gradient-to-r from-transparent via-accent/30 to-transparent group cursor-pointer overflow-hidden">
            <div className="h-full w-full bg-[#07101e] rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 hover:bg-[#0f2142]/40 transition-colors duration-500">
              ...
              <Link
                href="/services"
                className="shrink-0 inline-flex items-center justify-center px-8 py-4 bg-accent text-[#07101e] font-medium rounded-lg hover:bg-white transition-all shadow-lg hover:shadow-accent/20 uppercase tracking-widest text-sm w-full md:w-auto"
              >
